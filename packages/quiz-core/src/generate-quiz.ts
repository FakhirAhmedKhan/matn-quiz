...
} from "./hide-line-engine";
import {
  generateHideWordQuiz,
  type HideWordQuizResult,
} from "./hide-word-engine";
import {
  assertValidGenerateQuizInput,
  validateGenerateQuizInput,
  type GenerateQuizValidationIssue,
  type UnknownGenerateQuizInput,
} from "./generate-quiz-validation";
import type { RandomNumberGenerator as LineRandomNumberGenerator } from "./line-selection";
import type { RandomNumberGenerator as WordRandomNumberGenerator } from "./word-selection";
import type {
  GenerateQuizInput,
