import { HIDE_COUNT_DEFAULT, HIDE_COUNT_MIN, QUIZ_METHODS } from "./constants";
import { countArabicWords, countValidLines } from "./arabic";
...
export function isValidHideCount(
  ...
  return (
    Number.isInteger(value) && value >= HIDE_COUNT_MIN && value <= available
  );
}
