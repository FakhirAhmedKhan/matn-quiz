...
export function getPreviousBookPage(
  page: number,
  totalPages: number,
): number {
  return clampBookPage(
...
export function getNextBookPage(
  page: number,
  totalPages: number,
): number {
  return clampBookPage(
...
export function getFirstBookPage(): number {
  return 1;
}

export function getLastBookPage(
  totalPages: number,
): number {
  return Math.max(
    1,
...
export function normalizeBookReaderMode(
  value: unknown,
): BookReaderMode {
  return value === "FOCUS"
    ? "FOCUS"
...
export function normalizeBookReaderFontSize(
  value: unknown,
): BookReaderFontSize {
  if (
    value === "SMALL" ||
...
export function getBookReaderState(
  page: number,
  totalPages: number,
): BookReaderState {
  const safePage =
