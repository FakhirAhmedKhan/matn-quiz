...
Write-Host "=== FIX V3: HISTORY REDIRECT + HIDE-LINE TTS ===" -ForegroundColor Cyan
...
if ($ok) {
    Write-Host ""
    Write-Host "Skipping optional History page test discovery." -ForegroundColor Yellow
    Write-Host "The focused History/TTS regression suite already passed." -ForegroundColor Green
}
...
if ($ok) {
    ...
    Write-Host ""
    Write-Host "=== FIX V3 PASSED ===" -ForegroundColor Green
